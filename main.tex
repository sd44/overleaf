...
\documentclass[UTF8, fontset = none, a4paper, oneside, % twoside, openany,
zihao = -4, scheme=chinese, no-math]{ctexbook}
...
\newcommand{\lmrsl}{\fontspec{lmromanslant12-regular.otf}}
\newcommand{\lmrit}{\fontspec{lmroman12-italic.otf}}
\newenvironment{dedication}
{\clearpage           % we want a new page      
  \large
  \thispagestyle{empty}% no header and footer
  \vspace*{\stretch{1}}% some space at the top
  \lmrsl             % the text is Latin Modern in slshape
