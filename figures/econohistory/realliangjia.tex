\begin{figure}[!ht]
  ...
  \begin{tikzpicture}[baseline]
    \begin{axis}[width=15cm,height=6cm,% no markers,
      ...
      \addplot table [x=totalyear, y=total, col sep=comma] {realliangjia.csv};
    \end{axis}
  \end{tikzpicture}
  \vspace{-14pt}
  \caption{\label{fig:liangchanliang}1980--2017年粮食产量}
  ...
  \begin{tikzpicture}[baseline]
    \begin{axis}[width=15cm,height=6cm,% no markers,
      ...
      % \addplot+ [point meta=explicit symbolic, every node near coord/.append style={color=red}, nodes near coords,]
      \addplot table [x=totalyear, y=totalpercent, col sep=comma] {realliangjia.csv};
    \end{axis}
  \end{tikzpicture}
  \vspace{-14pt}
  \caption{\label{fig:liangzengzhang}1980--2017年粮食产量增长率（较上一年）}
  \capsource{资料来源：国家统计局，《中国统计摘要--2018）》}
  \bigskip \bigskip
  ...
  \begin{tikzpicture}[baseline]
    \begin{axis}[width=13cm,height=6cm,% no markers,
      ...
      % \addplot+ [point meta=explicit symbolic, every node near coord/.append style={color=red}, nodes near coords,]
      \addplot table [x=x, y=y, col sep=comma] {realliangjia.csv};
    \end{axis}
  \end{tikzpicture}
  \vspace{-14pt}
  \caption{\label{fig:liangjia}1980--1998年粮食市场真实价格（1978年不变价格）}
